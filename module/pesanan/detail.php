...
<div id="frame-faktur">
	...
	<table class="table-list">
		...
		<?php
			...
			$queryDetail = mysqli_query($koneksi, "SELECT pesanan_detail.*, barang.nama_barang FROM pesanan_detail JOIN barang USING (barang_id) WHERE pesanan_id='$pesanan_id' ");
		...
		<tr>
			<td class="kanan" colspan="4">Biaya Pengirim</td>	
...
<div id="frame-keterangan-pembayaran">
	<p>Silahkan Lakukan pembayaran ke Bank BCA <br>
		Nomor Account : 0000-1111-2222 (A/N Vento Deco) <br>
		Setelah melakukan pembayaran silahkan lakukan konfirmasi pembayaran
		<a href="<?php echo BASE_URL."index.php?page=profilku&module=pesanan&action=konfirmasi_pembayaran&pesanan_id=$pesanan_id"; ?>">Disini</a>	</p>
</div>