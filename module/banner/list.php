<div id="frame-tambah">
	<a class="tombol-action" href="<?php echo BASE_URL."index.php?page=profilku&module=banner&action=form"; ?>">+ Tambah Banner</a>
</div>
...
<?php
    ...
    // membuat tabel dari data tapi sebelum itu cek apakah ada datanya 
        ...
        echo "<table class='table-list'>";
            ...
            while($rowBanner=mysqli_fetch_array($queryBanner))
            {
                echo "<tr>
                        ...
                        <td class='tengah'><a class='edit-a' href='".BASE_URL."index.php?page=profilku&module=banner&action=form&banner_id=$rowBanner[banner_id]"."'>Edit</a></td>
                     </tr>";
